...
export function ImapStreamingLogs({ combinedLogs, clearLogs, caseId }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      <div 
        ...
        className="card" 
        style={{ maxHeight: 280, overflowY: "auto", background: "#0b0f19", border: "1px solid #1e293b", padding: 14 }}
      >
        <div className="row between mb-2" style={{ position: "sticky", top: 0, background: "#0b0f19", zIndex: 2, paddingBottom: 6 }}>
      ...
      {!autoScroll && (
        ...
        >
          ↓ Auto-scroll Paused (Click to follow live)
        </button>
      )}
    </div>
  );
